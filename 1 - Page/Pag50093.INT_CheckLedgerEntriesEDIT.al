page 50093 "INT_Check Ledger Entries EDIT"
{
    ApplicationArea = Basic, Suite;
    Caption = 'Check Ledger Entries EDIT';
    ...
    layout
    {
        area(content)
        {
            repeater(Control1)
            {
                ...
                field("AVF_Pay-to Description"; "AVF_Pay-to Description")
                {
                    Caption = 'Pay-to Description';
                    ApplicationArea = Basic, Suite;
                    ToolTip = 'Specifies a printing Pay-to Description for the check ledger entry.';
                    Editable = true;
                }
                field(Amount; Amount)
                {
