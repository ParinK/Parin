report 50052 "INT_Import Budget from Excel 2"
{
    ...
    dataset
    {
        dataitem(BudgetBuf; "Budget Buffer")
        {
            ...
            begin
                ...
                //GLBudgetEntry.Description := BudgetBuf.INT_Description;  //AVPKJINT.001 24/12/2019
                //GLBudgetEntry.Description := INT_Description;  //AVPKJINT.001 24/12/2019
                //Message('INT_Description : %1', INT_Description);
                GLBudgetEntry.Description := INT_Description;
    ...
    var
        ...
        //TempExcelBuf2: Record "Excel Buffer" temporary;
                    ...
                    ExcelBuf."Row No." = HeaderRowNo:
                        begin
                            ...
                            case true of
                                ...
                                //AVPKJINT.001 26/12/2019
                                TempExcelBuf."Cell Value as Text" = Text029:
                                    BEGIN
                                        TempExcelBuf.Comment := Text029;
                                        TempExcelBuf.INSERT;
                                    END;
                            //C-AVPKJINT.001 26/12/2019
                        ...
                        begin
                            ...
                            if TempExcelBuf.FindFirst then
                                case TempExcelBuf.Comment of
                                    ...
                                    //AVPKJINT.001 26/12/2019
                                    Text029:
                                        DummyBudgetBuf.INT_Description :=
                                          COPYSTR(
                                            ExcelBuf."Cell Value as Text",
                                            1, MAXSTRLEN(DummyBudgetBuf.INT_Description));
                                    //C-AVPKJINT.001 26/12/2019 
