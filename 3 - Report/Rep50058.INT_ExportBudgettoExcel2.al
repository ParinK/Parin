report 50058 "INT_Export Budget to Excel 2"
{
    Caption = 'Export Budget to Excel 2';
    ProcessingOnly = true;
    ...
    dataset
    {
        dataitem("G/L Budget Entry"; "G/L Budget Entry")
        {
            ...
            begin
                ...
                TempBudgetBuf1.INT_Description := "G/L Budget Entry".Description;  //AVPKJINT.001 02/01/2020 add code
            ...
            begin
                ...
                if GLAcc.Find('-') then
                    repeat
                        ...
                        //  GLAcc."Account Type" <> GLAcc."Account Type"::Posting, false, '', ExcelBuf."Cell Type"::Text);  //AVPKJINT.001 03/01/2020 comment code
                        EnterCell(
                        ...
                        if (GLAcc.Totaling = '') or (not IncludeTotalingFormulas) then begin
                            ...
                            if TempBudgetBuf2.Find('-') then begin
                                ...
                                EnterDimValues;
                                //AVPKJINT.001 03/01/2020 add code
                                if TempBudgetBuf2.FindFirst then
                                    EnterCell(RowNo, 2, TempBudgetBuf2.INT_Description, GLAcc."Account Type" <> GLAcc."Account Type"::Posting, false, '', ExcelBuf."Cell Type"::Text);
                                //C-AVPKJINT.001 03/01/2020 add code
                                if TempPeriod.Find('-') then;
                                repeat
                                    if IsDimDifferent(TempBudgetBuf1, TempBudgetBuf2) then begin

                                        RowNo := RowNo + 1;
                                        EnterCell(RowNo, 1, GLAcc."No.", GLAcc."Account Type" <> GLAcc."Account Type"::Posting, false, '', ExcelBuf."Cell Type"::Text);
                                        EnterCell(RowNo, 2, TempBudgetBuf2.INT_Description, GLAcc."Account Type" <> GLAcc."Account Type"::Posting, false, '', ExcelBuf."Cell Type"::Text);  //AVPKJINT.001 03/01/2020 add code
                                        EnterDimValues;
                                        TempBudgetBuf1 := TempBudgetBuf2;
                                    end;
